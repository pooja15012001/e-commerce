...
//   const [newComment, setNewComment] = useState({ comment: "" ,postId:""});

//   useEffect(() => {
//     const fetchComments = async () => {
//       const commentsRef = collection(firestore, "comments");
//       console.log(commentsRef,"refvalue")
...
//       // Fetch the comments again to update the comments state with the new comment
//       const commentsQuery = query(commentsRef, where("postId", "==", postId));
//       const commentsSnapshot = await getDocs(commentsQuery);
//       const commentsData = commentsSnapshot.docs.map((doc) => doc.data());
//       setComments(commentsData);
...
//               <div className="trending-div" key={trending.id}>
//                 <div>
//                   <div>
//                     <img src={Trendingimg} />
//                   </div>
